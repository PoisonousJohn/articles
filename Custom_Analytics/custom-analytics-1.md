...
* [ ] Добавить оценку полного деплоймента в облако, включая Hot Path
...
Что-то опять дороговато. Записывать можно батчами, как минимум еще 1000 ивентов в батче. Таким образом будет упаковать и на уровне клиентского приложения, и батч записи на уровне разбора EventHub.
